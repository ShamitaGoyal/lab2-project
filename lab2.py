...
class MainWindow(tk.Tk):
    ...
    def __init__(self):
        ...
        H1 = tk.Label(self, text=f'Highest yearly rainfall: {int(year)}, {inches:.2f} inches', font=("Inter", 17), fg="LightGoldenrodYellow", bg="aquamarine4")

        year, inches = r.get_lowestR
        H2 = tk.Label(self, text=f'Lowest yearly rainfall: {int(year)}, {inches:.2f} inches', font=("Inter", 17), fg="LightGoldenrodYellow", bg="aquamarine4")
